(() => {
  var e = {
      152: (e) => {
        e.exports = (e) => {
          ...
          return (
            t.classList.add("film-card"),
            (n.href = "#"),
            r.classList.add("film-image-container"),
            o.classList.add("film-information"),
            s.classList.add("film-rate"),
      ...
      714: (e, t, n) => {
        const r = n(152),
          o = document.getElementById("films-Section");
        e.exports = (e) => {
          (o.innerHTML = ""), e.forEach((e) => o.appendChild(r(e)));
        };
      },
      425: (e, t, n) => {
        "use strict";
        ...
        const C = c("HTMLFormElement"),
          ...
          F = "0123456789",
          U = { DIGIT: F, ALPHA: L, ALPHA_DIGIT: L + L.toUpperCase() + F },
          B = c("AsyncFunction");
        var D = {
          isArray: u,
          isArrayBuffer: d,
        ...
        class Fe {
          ...
          getUri(e) {
            return X(
              we((e = Ce(this.defaults, e)).baseURL, e.url),
              e.params,
              e.paramsSerializer
            );
          }
        ...
        (Me.Axios = Ue),
          ...
          (Me.mergeConfig = Ce),
          (Me.AxiosHeaders = he),
          (Me.formToJSON = (e) => se(D.isHTMLForm(e) ? new FormData(e) : e)),
          (Me.getAdapter = Te),
  ...
  (n.g = (function () {
    ...
    (() => {
      ...
      (async () => {
        try {
          return (await t.get("http://localhost:3000/movies")).data;
        } catch (e) {
          console.log(e);
        }
      })().then((t) => e(t));
